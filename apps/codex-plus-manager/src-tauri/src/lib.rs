...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::load_remote_control,
            commands::save_remote_control,
            commands::check_remote_dependencies,
            commands::load_remote_inventory,
            commands::handle_remote_bot_message,
            commands::remote_bridge_status,
            commands::start_remote_bridge,
            commands::stop_remote_bridge,
            commands::read_remote_bridge_log,
