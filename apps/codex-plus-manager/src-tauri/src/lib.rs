...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::image::load_prompt_agent,
            commands::image::save_prompt_agent,
            commands::image::enhance_image_prompt,
            commands::image::generate_image,
            commands::image::open_generated_image,
            commands::image::save_generated_image_as,
